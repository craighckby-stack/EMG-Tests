...
### ❌ [2026-09-08] src/specimen_05_typescript.ts `source: mutation-cycle`
...
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on src/specimen_05_typescript.ts.
